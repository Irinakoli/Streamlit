...
def load_data():
    file = "C:/Users/Larysa/Desktop/PyCharm_projects/Cyprus sentiment app/file.xlsx"
...
data["preprocessed_reviews"] = data["review"].apply(lambda x: preprocess_review(x, selected_pos))
